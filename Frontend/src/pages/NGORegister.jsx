...
const NGORegister = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const result = await registerUser(registrationData, 'ngo')
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-center space-x-4">
            ...
            <div className={`w-8 h-0.5 ${step >= 3 ? 'bg-primary-600' : 'bg-gray-200'}`}></div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    {errors.rescueCategories && (
                      <p className="mt-1 text-sm text-red-600">{errors.rescueCategories.message}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {errors.rescueDistance && (
                      <p className="mt-1 text-sm text-red-600">{errors.rescueDistance.message}</p>
                    )}
                  </div>
